...
<%
    ...
    String sqlPagination="SELECT SQL_CALC_FOUND_ROWS * FROM tipovisoba where hotelID="+user.getHotelID()+" limit "+iPageNo+","+iShowRows+"";
...
<body>
  ...
  <form class='slideUpForm' method="POST" name="newrt" action="${pageContext.request.contextPath}/KreirajTipSobe" enctype="multipart/form-data">
    ...
    <label>Naziv</label><input name="rtname" required type='text'>
...
%>                     
        ...
        {
         %>
          <a class='page gradient' href="${pageContext.request.contextPath}/menadzer/tipovisoba.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>"> << Previous</a>
         <%
        }
        ...
        for(i=((cPage*iTotalSearchRecords)-(iTotalSearchRecords-1));i<=(cPage*iTotalSearchRecords);i++)
        {
          ...
          {
          %>
           <a class='page gradient' href="${pageContext.request.contextPath}/menadzer/tipovisoba.jsp?iPageNo=<%=i%>" style="color: #59d"><b><%=i%></b></a>
          <%
          }
          else if(i<=iTotalPages)
          {
          %>
           <a class='page gradient' href="${pageContext.request.contextPath}/menadzer/tipovisoba.jsp?iPageNo=<%=i%>"><%=i%></a>
          <% 
          }
        }
        ...
        {
         %>
         <a class='page active' href="${pageContext.request.contextPath}/menadzer/tipovisoba.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>"> >> Next</a> 
         <%
        }
        }
      %>
