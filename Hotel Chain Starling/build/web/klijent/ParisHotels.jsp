...
<%
    ...
    String sqlPagination="SELECT SQL_CALC_FOUND_ROWS * FROM hoteli where grad='Paris' limit "+iPageNo+","+iShowRows+"";
	...
	<main class="main" role="main" id="main-content">-->
            ...
            <%
                ...
                try
                {
                    ...
                    String upit = "select * from klijenti where username='"+user.getUsername()+"'";
	...
	<div class="header">
		...
		<nav class="clearfix">
				...
				<a href="#" id="pull">Menu</a>
                         ...
                         <img src="${pageContext.request.contextPath}/klijent/images/paris_1.jpg" alt="Paris" style="height: 550px; width: 100%;"/>
<!--start main -->
<div class="main_bg">
    <div class="wrap">
        <div class="main">
	...
	<div class="b_room">
		...
		<div class="reservation">
			...
			<ul>
				...
				<input type="text" name="lokacija" required readonly="readonly" value="Paris" oninvalid="this.setCustomValidity('Enter city here')" oninput="this.setCustomValidity('')">
		...
		<div class="res_online">
			...
			<p class="para">Paris is known as the City of Light for a variety of reasons: Originally, the Champs-Élysées was dotted with lamps during the 19th century. Today, the glittering Eiffel Tower, lamplit bridges over the Seine, and the array of art museums, palaces, and gardens create that iconic Parisian charm. Explore the sights from the Champs-Élysées to the Louvre when you stay at a Starling hotel in Paris.</p>
		</div>			
        </div>
    </div>
</div>	
...
%>                     
        ...
        {
         %>
          <a class='page gradient' href="${pageContext.request.contextPath}/klijent/ParisHotels.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>"> << Previous</a>
         <%
        }
        ...
        for(i=((cPage*iTotalSearchRecords)-(iTotalSearchRecords-1));i<=(cPage*iTotalSearchRecords);i++)
        {
          ...
          {
          %>
           <a class='page gradient' href="${pageContext.request.contextPath}/klijent/ParisHotels.jsp?iPageNo=<%=i%>" style="color: #59d"><b><%=i%></b></a>
          <%
          }
          else if(i<=iTotalPages)
          {
          %>
           <a class='page gradient' href="${pageContext.request.contextPath}/klijent/ParisHotels.jsp?iPageNo=<%=i%>"><%=i%></a>
          <% 
          }
        }
        ...
        {
         %>
         <a class='page active' href="${pageContext.request.contextPath}/hotels/ParisHotels.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>"> >> Next</a> 
         <%
        }
        }
      %>
