...
<%
    ...
    String sqlPagination="SELECT SQL_CALC_FOUND_ROWS * FROM hoteli where grad='New York' limit "+iPageNo+","+iShowRows+"";
...
function validatecidate(cidate)
{
    ...
    {
      errorMsg = "Polje datum dolaska polje mora biti popunjeno!";
    }
	...
	<main class="main" role="main" id="main-content">-->
            ...
            <%
                ...
                try
                {
                    ...
                    String upit = "select * from klijent where username='"+user.getUsername()+"'";
...
<div class="wrap">
	<div class="header">
		...
		<nav class="clearfix">
         ...
         <img src="${pageContext.request.contextPath}/klijent/images/newyork.jpg" alt="New York" style="height: 550px; width: 100%;"/>
<!--start main -->
<div class="main_bg">
    <div class="wrap">
         <div class="main">
	...
	<div class="b_room">
		...
		<div class="reservation">
			...
			<ul>
				...
				<input type="text" name="lokacija" required readonly="readonly" value="New York" oninvalid="this.setCustomValidity('Enter city here')" oninput="this.setCustomValidity('')">
		...
		<div class="res_online">
			<h4>Hotels in New York City</h4>
			<p class="para">Consisting of five diverse boroughs, New York City is an international hub for business and culture. Discover both must-see sights, such as Times Square, the Empire State Building, and MoMA, as well as under-the-radar gems including neighborhood eateries, intimate music venues, and historic hideaways. From the Brooklyn Bridge to Central Park, Starling hotels puts you near it all in New York City.</p>
		</div>			
        </div>
    </div>
</div>	
...
%>                     
        ...
        {
         %>
          <a class='page gradient' href="${pageContext.request.contextPath}/klijent/NewYorkHotels.jsp?iPageNo=<%=prePageNo%>&cPageNo=<%=prePageNo%>"> << Previous</a>
         <%
        }
        ...
        for(i=((cPage*iTotalSearchRecords)-(iTotalSearchRecords-1));i<=(cPage*iTotalSearchRecords);i++)
        {
          ...
          {
          %>
           <a class='page gradient' href="${pageContext.request.contextPath}/klijent/NewYorkHotels.jsp?iPageNo=<%=i%>" style="color: #59d"><b><%=i%></b></a>
          <%
          }
          else if(i<=iTotalPages)
          {
          %>
           <a class='page gradient' href="${pageContext.request.contextPath}/klijent/NewYorkHotels.jsp?iPageNo=<%=i%>"><%=i%></a>
          <% 
          }
        }
        ...
        {
         %>
         <a class='page active' href="${pageContext.request.contextPath}/hotels/NewYorkHotels.jsp?iPageNo=<%=i%>&cPageNo=<%=i%>"> >> Next</a> 
         <%
        }
        }
      %>
