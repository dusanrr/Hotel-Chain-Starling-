...
public class ObrisiTipSobe extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getSession().getAttribute("user") != null && user.getPower().equals("Admin"))
        {
            try
            {
                ...
                stmt.executeUpdate("delete from tipovisoba where ID='"+roomtypeID+"'");
                request.setAttribute("popupid", 3);
                request.setAttribute("poruka", "Uspešno ste obrisali tip hotelske sobe.");
